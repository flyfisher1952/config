...
(custom-theme-set-faces
 ...
 '(diff-added ((default (:inherit diff-changed))
		...
		(:inherit diff-changed :background "color-22"))
	       (((type graphic))
		(:inherit diff-changed :background "#335533"))))
 ...
 '(ediff-fine-diff-C ((((type tty) (class color) (min-colors 256))
		       (:background "#afaf00"))))
 '(ediff-odd-diff-A ((t (:background "dim gray" :foreground "White"))))
 '(ediff-odd-diff-C ((((type tty) (class color) (min-colors 256))
		      (:background "dim gray" :foreground "White"))))
 '(font-latex-sectioning-5-face ((default (:foreground "DodgerBlue1" :weight semi-bold))
				 (((type tty) (class color) (min-colors 256))
				  (:foreground "#0087ff" :weight bold))))
 '(font-lock-builtin-face ((((min-colors 88))
			    (:foreground "gold" :inherit (default)))))
 '(font-lock-comment-face ((((type graphic))
			    (:foreground "cyan3" :inherit (italic)))
 ...
 '(font-lock-function-name-face ((((type graphic))
				  (:weight bold :foreground "white" :inherit (default)))
				 (((type tty))
				  (:foreground "brightblue" :weight bold))))
 '(font-lock-keyword-face ((((type graphic))
			    (:foreground "firebrick1" :inherit (italic)))
 ...
 '(font-lock-string-face ((((type graphic))
			   (:foreground "lawn green" :inherit (default)))
			  (((type tty)) (:foreground "green"))))
 '(font-lock-type-face ((t (:foreground "orchid" :inherit (italic)))))
 '(font-lock-variable-name-face ((((type graphic))
				  (:foreground "orange" :inherit (bold)))
				 (((type tty))
				  (:inherit default :foreground "DarkOrange1"))))
 '(font-lock-warning-face ((((type graphic))
			    (:foreground "Red1" :inherit (bold)))
			   (((type tty))
			    (:inherit (error bold)))))
 '(highlight ((default (:background "blue" :inherit (default)))
	      (((type graphic))
	       (:foreground "yellow" :background "blue" :inherit (default)))))
 ...
 '(message-header-cc ((((type tty) (class color) (min-colors 256))
		       (:foreground "#00d700"))))
 '(message-header-other ((((type tty) (class color) (min-colors 256))
			  (:foreground "#d75f00"))))
 '(message-header-subject ((((type tty) (class color) (min-colors 256))
			    (:foreground "#5fafff" :weight bold))))
 '(message-header-to ((((type tty) (class color) (min-colors 256))
		       (:foreground "#5fafff" :weight bold))))
 '(message-header-xheader ((((type tty) (class color) (min-colors 256))
			    (:foreground "#005f5f"))))
 ...
 '(mode-line-buffer-id ((((type graphic))
			 (:weight bold :foreground "red" :background "ghost white"))))
 ...
 '(org-level-4 ((default (:inherit outline-4))
		(((type tty) (min-colors 256))
		 (:inherit outline-4 :foreground "#00d7af"))))
